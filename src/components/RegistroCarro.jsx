...
export const RegistroCarro = () => {
  ...
  const submitHandler = (e) => {
    ...
    fetch("http://34.207.225.27:8080/vehicle", option)
    ...
    <form onSubmit={submitHandler}>
        <ul>
            ...
            <li>
                ...
                <input type="text" id="engineType" name="engineType" onChange={hEngineType}/>
            </li>

            <li>
                <label htmlFor="fuelType">Tipo de Combustible</label>
                <input type="text" id="fuelType" name="fuelType" onChange={hFuelType}/>
            </li>

            <li>
                <label htmlFor="serialNumber">Numero de Serie</label>
                <input type="number" id="serialNumber" name="serialNumber" onChange={hSerialNumber}/>
            </li>
            ...
            <li>
                <label htmlFor="nvi">Numero de Identificación Vehicular (NVI)</label>
            ...
            <li>
                ...
                <input type="text" id="lastname" name="lastname" onChange={hLastname}/>
            </li>

            <li>
                <label htmlFor="agency">Nombre de la Agencia que Procede</label>
                <input type="text" id="agency" name="agency" onChange={hAgencyName}/>
